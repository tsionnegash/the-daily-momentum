import { Instagram, Youtube, Heart, Linkedin } from "lucide-react";
import dmLogo from "@/assets/dm-logo.png";

const Footer = () => {
  return (
    <footer className="section-padding bg-[#5d222a]">
      <div className="container-wide">
        ...
        <div className="flex justify-center mb-8">
          <div className="flex items-center gap-3">
            ...
            <span className="font-serif text-3xl font-bold tracking-tight text-[#E8C547]">
              DM
            </span>
          </div>
        </div>

        {/* Social Icons - Now golden */}
        <div className="flex items-center justify-center gap-6 mb-8">
          ...
          <a
            ...
            className="text-[#E8C547] hover:opacity-70 transition-opacity"
          >
            <Instagram size={24} />
          </a>
        ...
        <div className="text-center text-sm text-[#ebebeb]/70">
          <p className="flex items-center justify-center gap-1">
            ...
            <Heart size={14} className="text-[#ebebeb] fill-[#ebebeb]" /> for
